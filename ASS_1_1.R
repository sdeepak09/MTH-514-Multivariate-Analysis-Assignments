...
library(rgl)
plot3d(data_new,type = 's',xlab = "PCA1",ylab = "PCA2",zlab =  "PCA3",radius = 0.01)
...
View(data_new_1)
plot3d(data_new_1,type = 's',xlab = "PCA1",ylab = "PCA2",zlab =  "PCA3",radius = 0.01)
text3d(data_new_1,texts=as.factor(c(1:103)),col="red")


## Clustering of the countries
clust=kmeans(data_new_1,4, iter.max = 100,nstart = 3)
cl=clust$cluster
